            ...
            <div class="best-selling-products p-3 mb-3">
                <div class="d-flex align-items-center">
                    <div class="product-img">
                        <img src="{{ asset('admin') }}/images/icons/ice-cream-cornet.png" class="p-1" alt="" />
                    </div>
                    <div class="ps-3">
                ...
                <div class="d-flex align-items-center">
                    <div class="product-img">
                        <img src="{{ asset('admin') }}/images/icons/wine-glass.png" class="p-1" alt="" />
                    </div>
                    <div class="ps-3">
                ...
                <div class="d-flex align-items-center">
                    <div class="product-img">
                        <img src="{{ asset('admin') }}/images/icons/banana.png" class="p-1" alt="" />
                    </div>
                    <div class="ps-3">
                ...
                <div class="d-flex align-items-center">
                    <div class="product-img">
                        <img src="{{ asset('admin') }}/images/icons/telephone.png" class="p-1" alt="" />
                    </div>
                    <div class="ps-3">
                ...
                <div class="d-flex align-items-center">
                    <div class="product-img">
                        <img src="{{ asset('admin') }}/images/icons/plate.png" class="p-1" alt="" />
                    </div>
                    <div class="ps-3">
                ...
                <div class="d-flex align-items-center">
                    <div class="product-img">
                        <img src="{{ asset('admin') }}/images/icons/ice-cream-cornet.png" class="p-1" class="" alt="" />
                    </div>
                    <div class="ps-3">
                        <h6 class="mb-0 font-weight-bold">Cone Ice Cream</h6>
                        <p class="mb-0 text-secondary">$29/Each 56 Orders</p>
        ...
        <div class="card-body">
            ...
            <div class="support-list p-3 mb-3">
                <div class="d-flex align-items-top">
                    <div class="">
                        <img src="{{ asset('admin') }}/images/avatars/avatar-1.png" width="45" height="45" class="rounded-circle" alt="" />
                    </div>
                    <div class="ps-2">
                ...
                <div class="d-flex align-items-top">
                    <div class="">
                        <img src="{{ asset('admin') }}/images/avatars/avatar-2.png" width="45" height="45" class="rounded-circle" alt="" />
                    </div>
                    <div class="ps-2">
                ...
                <div class="d-flex align-items-top">
                    <div class="">
                        <img src="{{ asset('admin') }}/images/avatars/avatar-3.png" width="45" height="45" class="rounded-circle" alt="" />
                    </div>
                    <div class="ps-2">
                ...
                <div class="d-flex align-items-top">
                    <div class="">
                        <img src="{{ asset('admin') }}/images/avatars/avatar-4.png" width="45" height="45" class="rounded-circle" alt="" />
                    </div>
                    <div class="ps-2">
                ...
                <div class="d-flex align-items-top">
                    <div class="">
                        <img src="{{ asset('admin') }}/images/avatars/avatar-5.png" width="45" height="45" class="rounded-circle" alt="" />
                    </div>
                    <div class="ps-2">
            ...
            <table class="table mb-0 align-middle">
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="product-img bg-transparent border">
                                <img src="{{ asset('admin') }}/images/icons/shoes.png" class="p-1" alt="">
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="product-img bg-transparent border">
                                <img src="{{ asset('admin') }}/images/icons/smartphone.png" class="p-1" alt="">
                            </div>
                        </td>
                        <td>Redmi Airdts</td>
                        <td>Craig Clayton</td>
                    ...
                    <tr>
                        <td>
                            <div class="product-img bg-transparent border">
                                <img src="{{ asset('admin') }}/images/icons/mouse.png" class="p-1" alt="">
                            </div>
                        </td>
                        <td>Magic Mouse 2</td>
                        <td>Julia Burke</td>
                    ...
                    <tr>
                        <td>
                            <div class="product-img bg-transparent border">
                                <img src="{{ asset('admin') }}/images/icons/tshirt.png" class="p-1" alt="">
                            </div>
                        </td>
                        <td>Coton-T-Shirt</td>
                        <td>Clark Natela</td>
                    ...
                    <tr>
                        <td>
                            <div class="product-img bg-transparent border">
                                <img src="{{ asset('admin') }}/images/icons/headphones.png" class="p-1" alt="">
                            </div>
                        </td>
                        <td>Headphones 7</td>
                        <td>Robin Mandela</td>
